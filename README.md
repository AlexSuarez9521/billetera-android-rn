...
tests/ y test-vectors/                pruebas Jest y el vector AES-GCM común a Kotlin y JS
...
[el documento de arquitectura](docs/Documento-de-arquitectura.pdf).
...
[la evidencia de pruebas](docs/Evidencia-de-pruebas.pdf).
